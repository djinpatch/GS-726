...
def plot_state(
    ...
    ax.contour(RR, ZZ, psi_plot, levels=100, colors="k", linewidths=0.35)
...
def plot_rz_scalar(
    ...
    cf = ax.contourf(RR, ZZ, field_plot, levels=100, norm=norm,cmap=cmap)
...
for j in range(Niter):
    ...
    delta_inf = np.mean(np.abs(delta))
